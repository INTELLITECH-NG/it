...
function Contact() {
    ...
    if (isset($_POST['contact'])) {
        ...
        $mail->SMTPAuth = true; 
        $mail->Username = 'info@intellitech.ng';
        $mail->Password = 'Kingofpop@50';
        $mail->SMTPSecure = 'ssl';
        $mail->Mailer = "smtp";
        $mail->SMTPKeepAlive = true;
        $mail->Port = 465;

        $mail->setFrom('info@intellitech.ng', 'INTELLITECH');
        $mail->addAddress($email, $name);
        $mail->addCC('info@intellitech.ng');
        $mail->isHTML(true); 
    ...
    <body style="background: #EDF0F2;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;">
                                                                        <div style="font-size:1px;line-height:20px;white-space:nowrap;">
                                                                            &nbsp;</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:25px;font-weight:900;line-height:1.2;text-align:left;">
                                                                            Welcome to INTELLITECH</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;font-weight:400;line-height:22px;text-align:left;">
                                                                            Hi <span style="font-weight: bold;">' .$name . '</span>,<br> We received below details from you today at ' . $date . '</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;">
                                                                        <p style="font-size:1px;margin:0px auto;border-top:2px solid #EDF0F2;width:100%;">
                                                                        </p>
                                                                ...
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;font-weight:700;line-height:22px;text-align:left;">
                                                                            Here are your information:</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;line-height:22px;text-align:left;">'.$message.'</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;">
                                                                ...
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;font-weight:400;line-height:22px;text-align:left;">
                                                                            <span style="font-style: italic;">One of our
                                                                                representatives will happily contact you
                                                                                within 24 hours.</span><br><span style="font-weight: bold;">The
                                                                                INTELLITECH Team</span></div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-bottom:0px;" align="center">
                                                                    <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;font-weight:400;line-height:22px;text-align:center;">
                                                                        <span style="font-weight: 900;">Questions or Enquiring?</span><br> send us mail at <a href="mailto:info@intellitech.ng" style="color:#3587CC; text-decoration: none;" target="_blank">info@intellitech.ng</a>.
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:30px;" align="center">
                                                                    <div style="cursor:auto;color:#818585;font-family:Lato, Arial, sans-serif;font-size:12px;font-weight:400;line-height:22px;text-align:center;">
                                                                        1 Dr Peter Odili Road, BY CAC, Trans Amadi, Port Harcourt, Nigeria</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
        ...
        if (!$mail->send()) {
            echo "<script>Swal.fire('Oops!','Mail Declined','error')</script>";
        } else {
            echo "<script>Swal.fire('Good job','Thanks for contacting Us','success')</script>";
        }
    }
}
...
function getQuote() {
    ...
    if (isset($_POST['quote'])) {
        ...
        $pnum = mysqli_real_escape_string($conn, trim($_POST['pnum']));
        $email = mysqli_real_escape_string($conn, trim($_POST['email']));
    ...
    <body style="background: #EDF0F2;">
                                                        ...
                                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;font-weight:400;line-height:22px;text-align:left;">
                                                                            Hi <span style="font-weight: bold;">' .$fullname . ' '.$pnum.'</span>,<br> We received below details from you today at ' . $date . '</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;">
                                                                ...
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;" align="left">
                                                                        <div style="cursor:auto;color:#3A3D3E;font-family:Lato, Arial, sans-serif;font-size:15px;line-height:22px;text-align:left;">'. $subject.'</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;">
        ...
        if (!$mail->send()) {
            echo "<script>Swal.fire('Oops!','Quotation Mail Declined','error')</script>";
        } else {
            echo "<script>Swal.fire('Good job','Quotation Mail Send Successfully','success')</script>";
        }
    }
