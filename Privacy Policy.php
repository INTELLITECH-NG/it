...
<html lang="en">
  ...
  <body>
      ...
      <main>
        <section class="well1">
          <div class="container">
            ...
            <h3 class="off1 primary">General information</h3>
            ...
            <hr>
            <h3 class="primary">Right to access, correct and delete data and to object to data processing</h3>
            ...
            <hr>
            <h3 class="primary">Management of personal data</h3>
            ...
            <hr>
            <h3 class="primary">Information We Collect</h3>
            ...
            <hr>
            <h3 class="primary">How We Use Your Information</h3>
            ...
            <hr>
            <h3 class="primary">Sharing Your Information</h3>
    ...
    <script src="js/script.js"></script><!-- coded by Guruskid -->
  </body>
</html>