...
<head>
  ...
  <script src="js/sweetalert2.all.min.js"></script><!--[if lt IE 9]>
    <html class="lt-ie9">
    ...
    <main>
          ...
          <ul class="slides clearfix ">
            <li>
              ...
              <section class="caption-1">
                <a href="" title="Everything Starts With a">
            ...
            <li>
              ...
              <section class="caption-2">
                <a href="" title="Innovative Ways">
                  <h2>Innovative Ways</h2>
                </a>
            ...
            <li>
              ...
              <section class="caption-3">
                <a href="" title="a Driving Force">
                  <h2>a Driving Force</h2>
                </a>
            ...
            <li>
              ...
              <section class="caption-4">
                <a href="" title="Is the One and Only Best">
                  <h2>Is the One and Only Best</h2>
                </a>
      ...
      <section id="carousel">
        <ul class="slides clearfix">
          <li>
            <a href="" title="Everything Starts With a">
              <h6>Everything Starts With a</h6>
            </a>
            <p class="desc tcolor">GREAT SOLUTION</p>
          </li>
          <li>
            <a href="" title="Innovative Ways">
              <h6>Innovative Ways</h6>
            </a>
            <p class="desc tcolor">PERFECT RESULTS!</p>
          </li>
          <li>
            <a href="" title="a Driving Force">
              <h6>a Driving Force</h6>
            </a>
            <p class="desc tcolor">IN YOUR BUSINESS</p>
          </li>
          <li>
            <a href="" title="Is the One and Only Best">
              <h6>Is the One and Only Best</h6>
            </a>
            <p class="desc tcolor">IT COMPANY</p>
          </li>
        </ul>
            ...
            <li class="grid_6">
              <div class="box wow fadeInRight">
                ...
                <div class="box_cnt__no-flow">
                  ...
                  <p>we are passionate about and dedicated to our customers.</p>
                </div>
              </div>
              <hr>
              <div data-wow-delay="0.2s" class="box wow fadeInRight">
                ...
                <div class="box_cnt__no-flow">
                  ...
                  <p>we communicate with respect, integrity, courage and candour.</p>
                </div>
              </div>
            </li>
            <li class="grid_6">
              <div data-wow-delay="0.3s" class="box wow fadeInRight">
                ...
                <div class="box_cnt__no-flow">
                  ...
                  <p>we are innovators committed to addressing tomorrow's challenges today.</p>
                </div>
              </div>
              <hr>
              <div data-wow-delay="0.4s" class="box wow fadeInRight">
                ...
                <div class="box_cnt__no-flow">
                  ...
                  <p>we deliver quality solutions through exceptional implementation and support.</p>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="grid_4">
              ...
              <p>INTELLITECH is an information Technology Company, focused on providing optimal, Contemporary and Prospective ICT solutions in the World.</p>
              </p><a href="About" class="btn">Read more</a>
            </div>
