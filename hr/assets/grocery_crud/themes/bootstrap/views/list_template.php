<?php
	...
	$this->set_css($this->default_theme_path.'/bootstrap/css/jquery-confirm.min.css');
	...
	//$this->set_js_lib($this->default_theme_path.'/bootstrap/js/jquery.confirm.min.js');
	$this->set_js_lib($this->default_theme_path.'/bootstrap/js/jquery-confirm.min.js');
	$this->set_js_lib($this->default_theme_path.'/bootstrap/js/jquery.cookie.js');
...
<script type='text/javascript'>
    ...
    var shipping    =  '<?php echo lang('you_are_marking_this_order_as_shipped')?>';
    var tracking    =  '<?php echo lang('tracking_number')?>';
    var deliveryPerson    =  '<?php echo lang('delivery_person')?>';

    var message_alert_delete = "<?php echo $this->l('alert_delete'); ?>";
	
	$(document).ready(function(){
		$('.move-processing').confirm({
			content: '<?php echo lang('you_are_moving_this_order_to_shipping_module')?>',
			confirmButton: '<?php echo lang('confirm')?>',
			cancelButton: '<?php echo lang('cancel')?>'
		});
		
		$('.move-shipping').confirm({
			content: '<p>'+ shipping +'</p>' +
            '<div class="form-group">' +
            '<label>'+ tracking +'</label>' +
            '<input autofocus type="text" id="input-name" placeholder="Tracking Number" class="form-control">' +
            '<label>'+ deliveryPerson +'</label>' +
            '<input autofocus type="text" id="person" placeholder="Delivery Person" class="form-control">' +
            '</div>' +
			...
			confirm: function () {
				...
				var person = this.$b.find('input#person');
				location.href = this.$target.attr('href')+'/'+input.val()+'/'+person.val();
				return false;
			}
		});
	});
