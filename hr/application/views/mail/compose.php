...
<div class="col-md-12">
    ...
    <?php echo form_open_multipart('employee/mail/sendEmail') ?>
                                ...
                                ?>
                                    ...
                                    <option value="<?php echo $emp->id  ?>"
                                        <?php foreach($cc as $to) :
                                            $empID = $this->ion_auth->user()->row()->employee_id.'*'.'E';
...
<!--            </div>-->
        ...
        <div class="box-footer">
            ...
            <a type="reset" class="btn btn-default" href="<?php echo site_url('employee/mail') ?>">
