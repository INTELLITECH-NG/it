                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body ">
                        <div class="mailbox-controls">
                            ...
                            <!-- /.btn-group -->
                            <a href="<?php echo site_url('employee/mail/sentItem') ?>" type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
                    ...
                    <!-- /.box-body -->
                    <input type="hidden" name="url" value="employee/mail/sentItem">
                    <?php echo form_close() ?>
...
<script>
    //var table;
    var list        = 'employee/mail/sentBoxList';
</script>
