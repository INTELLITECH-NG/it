                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="text" name="company_name" class="form-control" value="<?php if(!empty($customer->company_name))echo $customer->company_name ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="text" name="phone" class="form-control" value="<?php if(!empty($customer->phone))echo $customer->phone ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="text" name="fax" class="form-control" value="<?php if(!empty($customer->fax))echo $customer->fax ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="text" name="website" class="form-control" value="<?php if(!empty($customer->website))echo $customer->website ?>">
                                            </div>
                                        </div>
