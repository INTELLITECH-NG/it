                ...
                <div class="wrap-fpanel">
                    <div class="box box-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('admin/reports/BalanceCheck', array('class' => 'form-horizontal')) ?>
                            <div class="panel_controls">
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="datepicker" name="start_date" data-date-format="yyyy/mm/dd" value="<?php if(!empty($search['start_date'])) echo $search['start_date'] ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="datepicker-1" name="end_date" data-date-format="yyyy/mm/dd" value="<?php if(!empty($search['end_date'])) echo $search['end_date'] ?>" required>
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar-o"></i>
                                            </div>
                                        </div>
